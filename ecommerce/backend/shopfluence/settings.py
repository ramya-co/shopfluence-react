"""
Django settings for shopfluence project.
"""
...
WSGI_APPLICATION = 'shopfluence.wsgi.application'
...
# Cache configuration for rate limiting tracking
CACHES = {
    'default': {
